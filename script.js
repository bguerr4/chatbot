...
function formatarClassificacao(dados) {
    ...
    if (Array.isArray(dados)) {
        ...
        if (!dados.categoria || !dados.setor_responsavel || !dados.acao_recomendada) {
